...
if [ $link1_status = "200" ] ; then 
	sudo wget -P /mediabots/WS2012R2.ISO /mediabots https://software-static.download.prss.microsoft.com/sg/download/888969d5-f34g-4e03-ac9d-1f9786c66749/SERVER_EVAL_x64FRE_en-us.iso
